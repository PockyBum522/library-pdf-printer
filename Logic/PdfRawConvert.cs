...
namespace Jds2
{
    ...
    public class PdfRawConvert
    {
        #region Static
        /// <summary>The name of the DLL i'm using to work</summary>
        public const string GhostScriptDLLName = "Resources\\gsdll64.dll";
        ...
        /// <returns></returns>
        [DllImport("Resources\\gsdll64.dll", EntryPoint="gsapi_init_with_args")]
        ...
        /// <param name="instance"></param>
        /// <returns></returns>
        [DllImport("Resources\\gsdll64.dll", EntryPoint="gsapi_exit")]
        ...
        /// </summary>
        /// <param name="instance"></param>
        [DllImport("Resources\\gsdll64.dll", EntryPoint="gsapi_delete_instance")]
        private static extern void gsapi_delete_instance (IntPtr instance);
        /// <summary>Get info about the version of Ghostscript i'm using</summary>
        /// <param name="pGSRevisionInfo"></param>
        /// <param name="intLen"></param>
        /// <returns></returns>
        [DllImport("Resources\\gsdll64.dll", EntryPoint="gsapi_revision")]
        ...
        /// <returns></returns>
        [DllImport("Resources\\gsdll64.dll", EntryPoint = "gsapi_set_stdio")]
        ...
        public int RenderingThreads
        {
            ...
            set {
                if (value == 0)
                    _iRenderingThreads = Environment.ProcessorCount - 1;
                else
        ...
        #endregion
        #region Init
        public PdfRawConvert(IntPtr objHandle)
        {
            _objHandle = objHandle;
        }

        public PdfRawConvert()
        {
        ...
        {
            return Convert(inputFile, outputFile, true,null);
        }
        ...
        {
            return Convert(inputFile, outputFile, true, parameters);
        }
        ...
        public bool Print(string inputFile, string printParameters)
        {
            ...
            if (string.IsNullOrEmpty(inputFile))
                throw new ArgumentNullException("inputFile");
            if (!System.IO.File.Exists(inputFile))
                throw new ArgumentException(string.Format("The file :'{0}' doesn't exist", inputFile), nameof(inputFile));
            //Avoid to work when the file doesn't exist
            if (string.IsNullOrEmpty(printParameters))
                throw new ArgumentNullException(nameof(printParameters), "{0} parameter is empty");
            #endregion
        ...
        private string[] GetGeneratedArgs(string inputFile, string outputFile,string[] presetParameters)
        {
            ...
            {// Thanks to Spillie to show me the error!
                ...
                if (lastDotIndex > 0)
                    outputFile = outputFile.Insert(lastDotIndex, "_%d");
            }
